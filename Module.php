...
{
    public $controllerNamespace = 'vladplanet\blog\controllers\frontend';
    ...
    public function init()
    {
        ...
        if ($this->getIsBackend() === true) {
            $this->setViewPath('@vladplanet/blog/views/backend');
        } else {
            $this->setViewPath('@vladplanet/blog/views/frontend');
            $this->setLayoutPath('@vladplanet/blog/views/frontend/layouts');
        }
		...
		Yii::$app->i18n->translations['blog'] = [
			...
			'basePath' => '@vladplanet/blog/messages',
