...
/* @var $searchModel \vladplanet\blog\models\BlogCommentSearch */
        ...
        'columns' => [
            ...
            [
                ...
                /*'filter' => Html::activeDropDownList(
                    $searchModel,
                    'post_id',
                    \vladplanet\blog\models\BlogPost::getArrayCategory(),
            ...
            [
                ...
                'format' => 'html',
                'value' => function ($model) {
                    if ($model->status === \vladplanet\blog\traits\IActiveStatus::STATUS_ACTIVE) {
                        $class = 'label-success';
                    } elseif ($model->status === \vladplanet\blog\traits\IActiveStatus::STATUS_INACTIVE) {
                        $class = 'label-warning';
                    } else {
                        $class = 'label-danger';
                    }
                ...
                'filter' => Html::activeDropDownList(
                    $searchModel,
                    'status',
                    \vladplanet\blog\models\BlogPost::getStatusList(),
