...
<div class="blog-post-form">
    ...
    <?= $form->field($model, 'content')->widget(\vladplanet\blog\widgets\Redactor\widgets\Redactor::class, [
    ...
    <?= $form->field($model, 'status')->dropDownList(\vladplanet\blog\models\BlogPost::getStatusList()) ?>
